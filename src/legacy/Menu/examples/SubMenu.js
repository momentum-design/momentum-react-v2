    ...
    return (
      ...
      >
        <Menu>
          ...
          <SubMenu label="help" title="help">
            <MenuItem value="healthChecker" label="healthChecker" onClick={this.onClick} />
            <MenuItem value="download" onClick={this.onClick}>
              <ListItemBaseSection position="left">download</ListItemBaseSection>
