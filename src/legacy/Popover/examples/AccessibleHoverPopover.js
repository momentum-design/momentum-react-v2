...
export default function PopOverHoverAccessible() {
  ...
  return (
    <div className="docs-example docs-example--spacing">
      <Popover content={content} includeFocusOnHover={false} autoFocusOnFirstElt>
        <Button id="accessible-hover-popover1">
      ...
      >
        <Button id="accessible-hover-popover2">
