...
class SpaceListItem extends React.PureComponent {
  ...
  render() {
    ...
    const getHeader = ['search', 'filter', 'flag', 'filter-search'].includes(type)
      ? [
          <span key="header-0" className="md-list-item__header-main">
            {header}
          </span>,
          headerSecondary && (
    ...
    const children = [
      ...
      <ListItemSection key="child-1" position="center">
        ...
        {['search', 'filter', 'flag', 'filter-search'].includes(type) ? (
          <ListItemSection position="center" className="md-list-item__result-container">
            {['flag'].includes(type) ? (
              <ListItemSection
                position="center"
              ...
              >
                <div className="md-list-item__attachment--top">
                  <ListItemSection position="center" className="md-list-item__attachment--top-left">
                ...
                {attachments && attachments.length && (
                  <div className="md-list-item__attachment--bottom">{attachments[0]}</div>
                )}
              </ListItemSection>
            ) : (
              <div className="md-list-item__result">{highlightSubheader(subheader)}</div>
            )}
          </ListItemSection>
        ) : (
          <div
