import {
  AUTO_CAPITALIZE,
  AUTO_COMPLETE,
} from '@momentum-design/components/dist/components/input/input.constants.js';
import { POPOVER_PLACEMENT } from '@momentum-design/components/dist/components/popover/popover.constants.js';
