...
Child `<Radio props=... >Some Element</Radio>` components

Passing an array of props into options.

The props that can be passed in this way are:
...
Extended `AriaRadioProps`. See [React aria useRadioGroup](https://react-spectrum.adobe.com/react-aria/useRadioGroup.html)
