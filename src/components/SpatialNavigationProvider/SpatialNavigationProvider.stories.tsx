...
const ButtonGrid = Template(({ backKey }) => {
  visualDebugger();
  return (
    <SpatialNavigationProvider
      navigationKeyMapping={{ ...DEFAULTS.SPATIAL_NAVIGATION_KEY_MAPPING, back: backKey }}
    >
      <main
        style={{
...
const TreeNavigation = Template(({ backKey }) => {
  visualDebugger();
  return (
    <SpatialNavigationProvider
      navigationKeyMapping={{ ...DEFAULTS.SPATIAL_NAVIGATION_KEY_MAPPING, back: backKey }}
